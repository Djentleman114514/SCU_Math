...
弧长：
\[
y'=\frac23(x-1)^{-1/3},\qquad
L=\int_1^2\sqrt{1+(y')^2}\dd x=\boxed{\frac{4\sqrt2-2}{3}}.
\]
\[
\int_0^1\frac{x^3}{\sqrt{1-x^2}}\dd x
...
计算
\[
\int_{-\sqrt2}^{\sqrt2}\int_{\sqrt{4-x^2}}^2 f(x,y)\dd y\dd x
...
故
\[
\int_{-1}^{1}\arctan(\ee^x)\dd x<\int_{-1}^1\frac\pi2\dd x=\pi.
\]
下界用
\[
...
>
\int_{-1}^{1}\frac{\ee^x}{1+\ee^{2x}}\dd x
=\int_{-1}^{1}\frac{\dd x}{\ee^x+\ee^{-x}}.
\]
由对称性和均值估计可得
\[
\int_{-1}^{1}\arctan(\ee^x)\dd x
